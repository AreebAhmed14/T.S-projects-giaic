...
// but json can be used in any language. json data consist of key value pair with "" sep by : . json dat is very easy 
// to parse and use.
//errors
...
// no = "areeb" //error
//null 
let nul = null; //only null acceptable in null type
//step 6 --------------------------------------------------------------------------------------------------
//explict casting
let user = "areeb";
...
let easy = (a, b) => a + b; //return automatically
console.log(easy(4, 5));
//type define in anonymous function
//syntax ()=>void 
let anonyType = function (num1, num2) {
    return num1 ** num2;
};
console.log(anonyType(3, 3)); //9
//option parameter
function order(color, message) {
    if (message) {
...
//default parameter
function defaultParam(color = "white", message = "hello") {
    return "your " + color + " shirt is ready with " + message + " print...";
}
...
function restString(firstName, ...lastName) {
